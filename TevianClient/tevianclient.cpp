...
TevianClient::TevianClient() : ui(new Ui::TevianClient), manager(this)
{
    ...
    connect(this, &TevianClient::signal_updateImage, this, &TevianClient::on_updateImage);
}
...
void TevianClient::on_actionOpen_triggered()
{
...
void TevianClient::on_updateImage()
{  
